...
export class ShoeStore {
    ...
    public getShoes(): Observable<Shoe[]> {
        return this.http.get<Shoe[]>(this.baseUrl + '/shoe').pipe(tap(items => {
            this.shoesReplay.next(items);
        }));
    }

    getShoe(id: number): Observable<Shoe> {
        return this.http.get<Shoe>(this.baseUrl + '/shoe/' + id).pipe(tap(item => {
    ...
    postShoe(modelFormData: Shoe, fileToUpload: File ) {
        ...
        return this.http.post(this.baseUrl + '/Shoe', formData);
    }
    ...
    putShoe(modelFormData: Shoe, fileToUpload: File ) {
        ...
        return this.http.put(this.baseUrl + '/Shoe/' + modelFormData.id, formData);
    }
    ...
    deleteShoe(id: number) {
        return this.http.delete(this.baseUrl + '/Shoe/' + id);
    }

    getShoeByUserName(userName: string): Observable<Shoe[]> {
        return this.http.get<Shoe[]>(this.baseUrl + '/Shoe/username/' + userName);
    }

    refreshList() {
        this.http.get(this.baseUrl + '/Shoe').toPromise().then(res => {
